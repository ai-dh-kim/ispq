...
const NIA_NOTE =
  '※ NIA가 직접 운영하는 측정 시스템(speed.nia.or.kr)의 사업자별 속도측정 데이터 입니다. 이용자가 자발적으로 측정한 표본(가입 상품은 이용자 신고값)이라 절대값보다 사업자 간 상대·추세 비교에 적합합니다. 국내 전용이라 해외 ISP 비교는 없는 대신, 케이블 사업자(딜라이브·LG헬로비전·HCN·CMB)까지 비교할 수 있습니다. RAW데이터 수집 시작 일자(2026-07-15) 이후부터 일별 이력이 쌓입니다.';
