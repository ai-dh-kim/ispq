...
export const T = {
  ...
  peakTitle: '피크타임 성능 저하 — 혼잡(21–23시) vs 한산(02–05시)',
  peakNote: '※ 피크 분석은 시간대 비교가 필요하므로 항상 최근 고해상도(10분) 데이터를 사용합니다.',
  defenseRate: '처리량 방어율',
  peakDrop: '피크 하락률',
  latencySpike: '지연 급증률',
  busyAvg: '혼잡 평균',
  ...
  tooltipMedian: '중앙값',
  tooltipTotal: '총 샘플',
  tooltipTrimmed: '절단 샘플',
  tooltipRetained: '순 잔존율',
  lowSampleWarn: '⚠ 저표본 — 해석에 주의',
  unitHops: '홉',
  // API 설정 모달
  apiButton: 'API 설정',
